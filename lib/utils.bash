...
# NOTE: You might want to remove this if osqueryi is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if osqueryi has other means of determining installable versions.
  list_github_tags
}
...
download_release() {
  ...
  Darwin*)
    platform=macos
    url="$GH_REPO/releases/download/${version}/osqueryd-macos-bare-${version}.tar.gz"
    ;;
  esac
